...
import { Loader } from './';
import { ChangeEvent, InputHTMLAttributes, useContext, MouseEvent } from 'react';
...
const Input = ({ handleChange, name = 'default', ...props }: InputProps) => {
  return (
    <input
...
export const Welcome: React.FC = () => {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between py-12 px-4">
